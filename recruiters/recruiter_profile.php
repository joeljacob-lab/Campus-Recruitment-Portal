...
$sql = "SELECT name, company_name, company_address, email, phone, created_at FROM recruiters WHERE id = ?";
...
if (!$recruiter) {
    echo "Recruiter details not found.";
    exit();
}
?>
...
<div class="container-fluid">
    <div class="row">
          ...
          <p class="text-success">● Online</p>
            ...
            <ul class="nav flex-column">
                <li class="sidebar-item">
                    <a class="sidebar-link active" href="recruiter_profile.php">
     ...
     <!-- Main Content -->
     <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 250px;">
        <h2 class="mt-4">Admin Profile</h2>
        <form>
          <div class="mb-3">
            <label class="form-label">Company Name</label>
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($recruiter['company_name']); ?>" readonly>
          </div>
          <div class="mb-3">
            <label class="form-label">Contact Person</label>
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($recruiter['name']); ?>" readonly>
          </div>
          <div class="mb-3">
            <label class="form-label">Company Address</label>
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($recruiter['company_address']); ?>" readonly>
          </div>
          <div class="mb-3">
            <label class="form-label">Email</label>
            <input type="email" class="form-control" value="<?php echo htmlspecialchars($recruiter['email']); ?>" readonly>
          </div>
          <div class="mb-3">
            <label class="form-label">Contact Number</label>
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($recruiter['phone']); ?>" readonly>
          </div>
          <div class="mb-4">
            <label class="form-label">Registered Date</label>
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($recruiter['created_at']); ?>" readonly>
          </div>
