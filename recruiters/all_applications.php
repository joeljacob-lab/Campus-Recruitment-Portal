...
<div class="container-fluid">
    <div class="row">
     ...
     <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 13rem; margin-top: 2rem;">
        <h2 class="mb-4">All Applications Received</h2>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($row['job_posting_date']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['apply_date']) . "</td>";
                        echo "<td><a href='view_all_application_details.php?application_id=" . $row['application_id'] . "' class='btn btn-primary btn-sm'>View Details</a></td>";
                        echo "</tr>";
                    }
                } else {
