...
$query = "SELECT a.id AS application_id, a.apply_date, 
                 j.job_title, j.created_at AS job_posting_date, 
                 s.name 
          FROM applications a
          JOIN students s ON a.user_id = s.id
          JOIN jobs j ON a.job_id = j.id
          WHERE a.status = 'shortlisted' AND j.recruiter_id = ?";
        ...
        <img src="../assets/images/recruiter-icon" alt="Student" class="rounded-circle" width="80" height="80" />
          ...
          <p class="text-success">● Online</p>
            ...
            <ul class="nav flex-column">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link active" href="shortlisted_applications.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 18rem; margin-top: 2rem;">
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-header bg-dark text-white text-center">
                <h2 class="h4 mb-0"><i class="fas fa-check-circle me-2"></i>Shortlisted Applications</h2>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='view_shortlisted_details.php?application_id=" . $row['application_id'] . "' class='btn btn-primary btn-sm'>
                            ...
                            if ($result->num_rows === 0) {
                                echo "<tr><td colspan='6' class='text-center text-muted'>No shortlisted applications found.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
