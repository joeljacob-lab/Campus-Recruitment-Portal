...
// Fetch all job vacancies posted by this recruiter
$query = "SELECT id, job_title, created_at FROM jobs WHERE recruiter_id = ? ORDER BY created_at DESC";
...
<div class="container-fluid">
    <div class="row">
     ...
     <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 18rem; margin-top: 2rem;">
        <h2 class="text-primary">Manage Vacancy</h2>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td><a href='manage_vacancy_edit.php?id={$row['id']}' class='btn btn-primary btn-sm'>Edit Details</a></td>
                    </tr>";
                    $sno++;
                }
                ?>
