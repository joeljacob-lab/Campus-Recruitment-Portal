...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($newPassword !== $confirmPassword) {
        ...
        $stmt = $conn->prepare("SELECT password FROM recruiters WHERE id = ?");
        ...
        if (password_verify($currentPassword, $hashedPassword)) {
            ...
            $updateStmt = $conn->prepare("UPDATE recruiters SET password = ? WHERE id = ?");
            $updateStmt->bind_param("si", $newHashedPassword, $recruiterId);
        ...
        <img src="../assets/images/recruiter-icon" alt="Student" class="rounded-circle" width="80" height="80" />
          ...
          <p class="text-success">● Online</p>
            ...
            <ul class="nav flex-column">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link active" href="recruiter_settings.php">
