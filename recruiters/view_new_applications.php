...
$application_id = intval($_GET['id']); // Sanitize ID
...
if ($result->num_rows == 0) {
    die("No application found or unauthorized access.");
}
        ...
        <div class="card-body">
            ...
            <div class="text-center mt-4">
                <?php if ($status == 'shortlisted'): ?>
                    <p class="text-success fw-bold">The Application is already Shortlisted.</p>
                <?php elseif ($status == 'rejected'): ?>
                    <p class="text-danger fw-bold">The Application is already Rejected.</p>
                <?php else: ?>
