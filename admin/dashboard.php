...
// Fetch total registered recruiters
$sql_recruiters = "SELECT COUNT(*) AS total FROM recruiters";
$result_recruiters = $conn->query($sql_recruiters);
$total_recruiters = $result_recruiters->fetch_assoc()['total'];
...
$sql_applications = "SELECT COUNT(*) AS total FROM applications";
$result_applications = $conn->query($sql_applications);
$total_applications = $result_applications->fetch_assoc()['total'];
?>
...
<div class="container-fluid">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 18rem; margin-top: 2rem;">
      ...
      <div class="row my-4">
<!-- Recruiters Request Card -->
<div class="col-md-4 mb-4">
  <div class="card admin-card h-100 border-start border-warning border-4">
    <div class="card-body d-flex flex-column">
      <div class="d-flex justify-content-between align-items-start mb-3">
        <div>
          <h5 class="card-title text-dark mb-1">Recruiters Request</h5>
          <p class="text-muted small mb-3">Approve or Reject Recruiters</p>
        </div>
        <div class="admin-icon bg-warning-light">
          <i class="fas fa-user-tie text-warning"></i>
        </div>
      </div>
      <a href="recruiters_request.php" class="btn btn-warning mt-auto align-self-start">Manage Requests</a>
    </div>
  </div>
</div>

<!-- View/Delete Students Card -->
<div class="col-md-4 mb-4">
  <div class="card admin-card h-100 border-start border-danger border-4">
    <div class="card-body d-flex flex-column">
      <div class="d-flex justify-content-between align-items-start mb-3">
        <div>
          <h5 class="card-title text-dark mb-1">Student Accounts</h5>
          <p class="text-muted small mb-3">Manage Student Profiles</p>
        </div>
        <div class="admin-icon bg-danger-light">
          <i class="fas fa-users text-danger"></i>
        </div>
      </div>
      <a href="manage_students.php" class="btn btn-danger mt-auto align-self-start">Manage Students</a>
    </div>
  </div>
</div>
      </div>
