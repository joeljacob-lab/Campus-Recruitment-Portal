...
if (isset($_GET['viewid'])) {
    $id = intval($_GET['viewid']);
    
    // Fetching company details from recruiters table
    $sql = "SELECT company_name, name, company_address, phone, email, created_at FROM recruiters WHERE id = $id";
...
<head>
    ...
    <style>
 body {
            background-color:rgb(83, 163, 243); /* Light Blue Gray */
     }
        ...
        <img src="../assets/images/admin-icon2.png" alt="Admin" class="rounded-circle" width="80" height="80" />
          ...
          <p class="text-success">● Online</p>
            ...
            <ul class="nav flex-column">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link active" href="total_regcompany.php">
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 18rem; margin-top: 2rem;">
        ...
        <div class="card shadow-lg p-4">
            <div class="row mb-3">
                <div class="col-md-6">
                    <h5>Company Name:</h5>
                    <p class="text-muted"><?php echo htmlspecialchars($row['company_name']); ?></p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <p class="text-muted"><?php echo htmlspecialchars($row['company_address']); ?></p>
                </div>
                <div class="col-md-6">
                    <h5>Mobile Number:</h5>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <h5>Company Registration Date:</h5>
