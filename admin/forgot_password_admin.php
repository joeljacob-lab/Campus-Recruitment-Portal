...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>window.location.href='reset_password_admin.php?username=" . urlencode($username) . "';</script>";
        exit();
    } else {
        ...
        <div class="col-md-6 offset-md-3">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Admin - Forgot Password</h4>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
                    ...
                    <form method="POST">
                        ...
                        <a href="login_admin.php" class="btn btn-secondary float-end">Back to Login</a>
                    </form>
                </div>
            </div>
        </div>
