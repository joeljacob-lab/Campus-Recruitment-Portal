...
// Fetch user details
$user_query = "SELECT name, email FROM students WHERE id = ?";
...
// Fetch applied jobs of the user
$query = "SELECT a.apply_date, j.job_title, r.company_name, j.job_location, j.job_salary, j.job_type
          FROM applications a
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-left: 18rem; margin-top: 2rem;">
    <div class="container">
        <h2 class="mb-4">Applied Jobs of <?= htmlspecialchars($user['name']); ?></h2>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row['job_salary']); ?></td>
