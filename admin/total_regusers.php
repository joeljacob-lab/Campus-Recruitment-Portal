...
$sql = "SELECT id, unique_id, phone_number, created_at FROM students";
        ...
        if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>
                    ...
                    <td>
                      <a href='view_student_details.php?id={$row['id']}' class='btn btn-custom btn-green'>View Details</a>
                      <a href='applied_jobs.php?id={$row['id']}' class='btn btn-custom btn-yellow'>Applied Jobs</a>
                    </td>
                  </tr>";
          }
        } else {
