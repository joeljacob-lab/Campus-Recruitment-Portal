...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password !== $confirm_password) {
        ...
        if ($stmt->execute()) {
            $success = "Password updated successfully! <a href='admin_login.php'>Click here to login</a>";
        } else {
                ...
                <div class="card-body">
                    ...
                    <?php if (!$success): ?>
                        <form method="POST">
                            ...
                            <a href="admin_login.php" class="btn btn-secondary float-end">Back to Login</a>
                        </form>
                    <?php endif; ?>
                </div>
            </div>
