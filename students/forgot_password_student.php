...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM students WHERE username = ? AND email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>window.location.href='reset_password_student.php?username=" . urlencode($username) . "';</script>";
        exit();
    } else {
        ...
        <div class="col-md-6 offset-md-3">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Student - Forgot Password</h4>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
